...
let options = {
    fruits:["Banana",'Strawberry',"Orange","Coconut","Starfruit","Kiwi"],
    superheroes:["TheFlash","BatMan","Hulk","BlackPanther","CaptainAmerica","SpiderMan","Superman"],
    names:["Justice","Candance","Jamal","Anita","Dwight","Willis","Phyllis Brown","Mike","Milo","Myra","Barry"]
}
    ...
    for(let i = 65; i<91; i++){
        ...
        button.addEventListener("click",()=>{
            ...
            if(charArray.includes(button.innerText)){
                charArray.forEach((char,index)=>{
                    if(char == button.innerText){
                        ...
                        if(winCount == charArray.length){
                            resultText.innerHTML = `<h2 class="win-msg">Wow you managed to live!</h2>
                ...
                drawMan(count);
                if(count == 6){
                    resultText.innerHTML = `<h2 class="lose-msg">You're Dead!</h2>
                            <p>The word was <span>${chosenWord}</span></p>`
                            blocker();
                }
            }
